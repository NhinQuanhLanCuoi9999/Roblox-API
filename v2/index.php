...
<div style="margin-top: -20px; display: flex; align-items: center;">
    ...
    <input type="text" name="searchName" id="searchName" placeholder="Nhập tên" value="<?= isset($_POST['searchName']) ? htmlspecialchars($_POST['searchName']) : '' ?>" 
        style="padding: 9px; border: 1px solid #ccc;transform: translate(200px); border-radius: 5px; font-size: 16px; width: 130px; transition: border-color 0.3s; outline: none; margin-top: 20px; display: block; margin-left: auto; margin-right: auto;" 
